...
// в переменной n, то в переменную result запишем первые n символов строки str и добавим в конец троеточие '...'. 
// В противном случае в переменную result запишем содержимое переменной str.

function strreduction(str, n) {
    let result;
    if (str.length > n) {
    result = str.slice(0, n) + '...';
    return result} else {return result = str}
}

console.log(strreduction("Привет, Симба", 6));
console.log(strreduction("Привет, Симба", 45))